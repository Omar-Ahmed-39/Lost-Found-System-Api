...
public class HandoversController : BaseController
{
    ...
    public HandoversController(IUnitOfWork unitOfWork, IHandoverService handoverService)
    {
    ...
    public async Task<IActionResult> Create([FromBody] CreateHandoverDto dto)
    {
        ...
        var created = await _handoverService.CreateHandoverAsync(handover, GetUserId());
